...
if (isset($_POST["Submit"])) {
		...
		address='$HomeAddress' WHERE id='$SearchQueryParameter'";
...
?>
<form action="update.php?id=<?php echo $SearchQueryParameter; ?>" method = "post" id = "login-form" class = "login-form" autocomplete = "off" role = "main">
